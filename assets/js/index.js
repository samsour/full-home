...
var fullpage = _interopRequireWildcard(__webpack_require__(3));
...
(0, _jquery.default)(document).ready(function () {
  (0, _jquery.default)('.splitscreen').fullpage({
    verticalCentered: false
  });
  setTimeout(function () {
    (0, _jquery.default)('.loader').addClass('hidden');
  }, 1000);
  setTimeout(function () {
    (0, _jquery.default)('.splitscreen').removeClass('hidden');
  }, 1000);
  setTimeout(function () {
    (0, _jquery.default)('.arrow-down').removeClass('hidden');
  }, 3200);
});
